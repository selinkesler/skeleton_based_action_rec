...
class EhpiDataset_Carlos(Dataset):
...
class RemoveJointsOutsideImgEhpi_Carlos(object):
...
class TranslateEhpi_Carlos(object):
    def __init__(self, image_size: ImageSize):
        self.image_size = image_size
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
...
class NormalizeEhpi_Carlos(object):
    def __init__(self, image_size: ImageSize):
        if image_size.width > image_size.height:
...
class GaussianNoise_Carlos(object):
    def __init__(self, image_size: ImageSize):
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
        # else:
    ...
    def __call__(self, sample):
        ...
        noise_1 = np.random.normal(mu, sigma, [32,29])
        noise_2 = np.random.normal(mu, sigma, [32,29])      
...
class GaussianNoise_01_Carlos(object):
    def __init__(self, image_size: ImageSize):
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
        # else:
    ...
    def __call__(self, sample):
        ...
        noise_1 = np.random.normal(mu, sigma, [32,51])
        noise_2 = np.random.normal(mu, sigma, [32,51])      
...
class RemoveJointsEhpi_Carlos(object):
