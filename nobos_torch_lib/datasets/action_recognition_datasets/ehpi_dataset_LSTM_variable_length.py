...
class EhpiDataset_vari_len(Dataset):
    ...
    def load_X(self):
        ...
        for i in range(X_.shape[0]):
            for a in range (13500):
                if X_[i,a] == 3:
                    new_len = a
                    break
            new_array_var = np.zeros((1,new_len + 1))
            for c in range (new_len+1):
                new_array_var[]
...
class RemoveJointsOutsideImgEhpi_vari_len(object):
...
class ScaleEhpi_vari_len(object):
    def __init__(self, image_size: ImageSize):
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
        # else:
...
class TranslateEhpi_vari_len(object):
    def __init__(self, image_size: ImageSize):
        self.image_size = image_size
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
...
class NormalizeEhpi_vari_len(object):
    def __init__(self, image_size: ImageSize):
        if image_size.width > image_size.height:
...
class GaussianNoise_vari_len(object):
    def __init__(self, image_size: ImageSize):
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
        # else:
    ...
    def __call__(self, sample):
        ...
        noise_1 = np.random.normal(mu, sigma, [32,15])
        noise_2 = np.random.normal(mu, sigma, [32,15])      
...
class GaussianNoise_01_vari_len(object):
    def __init__(self, image_size: ImageSize):
        # if image_size.width > image_size.height:
        #     self.image_size = ImageSize(width=1, height=image_size.height/image_size.width)
        # else:
...
class FlipEhpi_vari_len(object):
...
class RemoveJointsEhpi_vari_len(object):
