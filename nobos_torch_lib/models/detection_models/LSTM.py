...
class LSTM(nn.Module) :
    ...
    def __init__(self, n_class=61, input_size=30, n_layers = 1, drop_prob = 0, n_hidden = 256, batch_size = 256):
    ...
    def forward(self, x, hidden, batch,input_seq) :
    
        x, hidden = self.lstm(x,hidden)
        # print("shapes :")
        # print(x.shape)
        # print(x)
        dim_input_seq = input_seq-1
        ...
        if batch == 1:
            ...
            for i in range(256):
                tensor[0][i] = x[0][dim_input_seq][i]  
