...
class SkeletonStickmanLimbsBase(SkeletonLimbsBase, Generic[T]):
    def __init__(self, skeleton_joints: SkeletonStickmanJoints, limb_class: Type[T]):
        ...
        self._right_ear_to_left_ear: T = limb_class(num=20,
                                                          joint_from=skeleton_joints.right_ear,
                                                          joint_to=skeleton_joints.left_ear)
        self._left_eye_to_right_eye: T = limb_class(num=21,
                                                        joint_from=skeleton_joints.left_eye,
                                                        joint_to=skeleton_joints.right_eye)
                                                        
        self._ear_center_to_eye_blick: T = limb_class(num=22,
                                                        joint_from=skeleton_joints.ear_center,
                                                        joint_to=skeleton_joints.eye_blick)   
                                                        
        self._eye_blick_to_eye_center: T = limb_class(num=23,
                                                        joint_from=skeleton_joints.eye_blick,
                                                        joint_to=skeleton_joints.eye_center)   		

        self._eye_blick_to_eye_forward: T = limb_class(num=24,
                                                        joint_from=skeleton_joints.eye_blick,
                                                        joint_to=skeleton_joints.eye_forward) 														
    ...
    @property
    def right_ear_to_left_ear(self) -> T:
        return self._right_ear_to_left_ear

    @property
    def left_eye_to_right_eye(self) -> T:
        return self._left_eye_to_right_eye
        
    @property
    def ear_center_to_eye_blick(self) -> T:
        return self._ear_center_to_eye_blick
        
    @property
    def eye_blick_to_eye_center(self) -> T:
        return self._eye_blick_to_eye_center
        
    @property
    def eye_blick_to_eye_forward(self) -> T:
        return self._eye_blick_to_eye_forward