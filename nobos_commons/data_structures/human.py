...
class Human(object):
    __slots__ = ['uid', 'skeleton', 'action', 'frame_num', '_bounding_box', '_score', 'root','_score_joints']
    ...
    @property
    def score_joints(self):
        _score_joints = []
        for joint in self.skeleton.score_joints:
            _score_joints.append(joint)
        return _score_joints
